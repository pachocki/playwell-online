    ...
    <div className="w-full h-screen pt-10">
      ...
      <section className="flex  justify-center items-center  m-auto   w-3/4 h-screen screen:w-[95%]   ">
        <form
          ...
          className="flex flex-col justify-evenly bg-zinc-900 w-1/2 h-full rounded-l-xl overflow-hidden  px-20 laptop:px-5 mobile:w-2/3 mobile:rounded-xl mobile:mt-20 "
        >
