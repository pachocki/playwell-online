...
const CoursesPricing = () => {
  ...
  return (
    <div className="relative overflow-hidden" id="subscription__container" ref={pricingContainer}>
    ...
    <div className="h-full  relative overflow-hidden  bg-black/80 z-20 ">
      <div className="absolute right-[0%] top-[-420px] z-20 laptop:right-[-40%] screen:right-[-70%] mobile:right-[-100%] mobile:top-0" ref={flying}>
        <img src={FortniteFly} alt="fortnite" className="w-[400px] h-[400px] mobile:w-[250px] mobile:h-[250px]"/>
      </div>
      <SubscriptionPlan/>
    </div>
    </div>
