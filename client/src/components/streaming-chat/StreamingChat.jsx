...
const StreamingChat = (props) => {
  return (
    <div className="rounded-xl bg-zinc-900 w-[98%]   border-[1px] border-gray-600 relative z-20 tablet:w-[75%] tablet:mt-0 mobile:w-full mobile:px-2 ">
      ...
      <div className="flex  px-1 ">
        ...
        <div className="flex flex-col gap-2 w-full h-full  mx-auto my-3 tablet:gap-1">
          ...
          <div className="w-full bg-zinc-900 border-[1px] border-gray-600 rounded-xl">
            ...
            <div className="flex-col pt-2 px-5 tablet:pt-1 tablet:px-2 ">
